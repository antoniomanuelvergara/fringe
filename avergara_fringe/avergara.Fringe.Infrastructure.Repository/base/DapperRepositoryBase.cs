...
namespace avergara.Fringe.Infrastructure.Repository
{
    ...
    public class DapperRepositoryBase
    {
        ...
        public DapperRepositoryBase(IConnectionFactory connectionFactory)
        {
        ...
        {
            var sql = string.Format("SELECT * FROM [{0}] WHERE Id={1}", typeof(T).Name, Id);
        ...
        public void Insert<T>(T obj)
        {
            ...
            using  (var connection = _connectionFactory.GetConnection)
            {
                //SetId(obj, 1, propertyContainer.IdPairs); //dmc
